...
public class _01_IntroToHashMaps {
    public static void main(String[] args) {
    	...
    	HashMap<Integer, Double> intro = new HashMap<Integer, Double>();
    	...
    	for (Integer s : intro.keySet()) {
    		System.out.println("The square root of " + s + " is " + intro.get(s));
    	}
